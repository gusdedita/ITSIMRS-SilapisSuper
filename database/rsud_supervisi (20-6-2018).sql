...
insert  into `supervisi_masalah`(`id_supervisi`,`masalah_medis`,`masalah_pelayanan`,`masalah_umum`,`status_medis`,`status_pelayanan`,`status_umum`,`tanggapan_medis`,`tanggapan_pelayanan`,`tanggapan_umum`) values ('2018-06-11/Pagi/Ruang ICU','Masalah Medis','-Masalah\r\n-Penunjang','-Maslah\r\n-Umum','Belum','Belum','Belum',NULL,NULL,NULL),('2018-06-11/Pagi/Ruang Apel','Apel masalah','Apel masalah penunjang pelayanan','apel administrasi umum masalah','Belum','Belum','Belum',NULL,NULL,NULL),('2018-06-19/Siang/Ruang VIP Pratama','- masalah medis','- masalah pelayanan','- masalah umum','Belum','Belum','Belum',NULL,NULL,NULL),('2018-06-19/Sore/Ruang Apel','- tidak ada masalah','- tidak ada masalah','- tidak ada masalah','Belum','Belum','Belum',NULL,NULL,NULL);
